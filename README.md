...
- **サイドメニュー統合 (2026-02)の更新**:
  - 「ユーザー管理」をサイドメニューに移設（`/admin/users`）→ ADMIN/DEVELOPERがアクセス可能。
  - 「組織管理」をサイドメニューに移設（`/admin/organization`）→ DEVELOPERのみアクセス可能。
...
- **アクセス**: サイドメニュー「組織管理」（`/admin/organization`）からアクセス（DEVELOPERのみ）。
