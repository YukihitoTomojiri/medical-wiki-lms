...
- **High Density Layout**: 垂直方向のマージンやパディングを削減し、高密度で一覧性の高いレイアウトを実現しました。
- **Active Nodes Control**: 高さ固定コンテナ（70vh）とStickyヘッダーにより、大量のデータも快適にブラウジング可能です。
- **Professional Aesthetics**: ボーダーやシャドウを繊細なものに変更し、モダンで軽量な印象に仕上げました。
